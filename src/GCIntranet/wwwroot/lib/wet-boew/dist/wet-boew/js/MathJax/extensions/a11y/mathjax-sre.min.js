...
goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={}};
...
sre.AuditoryDescription.prototype.descriptionString=function(){return this.context?this.context+" "+this.text:this.text};sre.AuditoryDescription.prototype.equals=function(a){return this.context==a.context&&this.text==a.text&&this.userValue==a.userValue&&this.annotation==a.annotation};sre.AuditoryDescription.speechString=function(a,b){return sre.AuditoryDescription.toString_(a,""===b?"":b||" ")};
sre.AuditoryDescription.toString_=function(a,b){switch(sre.Engine.getInstance().markup){case sre.Engine.Markup.SABLE:case sre.Engine.Markup.SSML:case sre.Engine.Markup.VOICEXML:return sre.AuditoryDescription.toMarkupString_(a,b);case sre.Engine.Markup.ACSS:return sre.AuditoryDescription.toAcssString_(a,b);default:return sre.AuditoryDescription.toSimpleString_(a,b)}};sre.AuditoryDescription.toSimpleString_=function(a,b){return sre.BaseUtil.removeEmpty(a.map(function(a){return a.descriptionString()})).join(b)};
sre.AuditoryDescription.toAcssString_=function(a,b){sre.AuditoryDescription.setScaleFunction(-2,2,0,10,0);for(var c=sre.AuditoryDescription.personalityMarkup_(a),d=[],e={open:[]},f=null,g=!1,h=0,k;k=c[h];h++)if(sre.AuditoryDescription.isMarkupElement_(k))sre.AuditoryDescription.mergeMarkup_(e,k);else if(sre.AuditoryDescription.isPauseElement_(k))g&&(f=sre.AuditoryDescription.mergePause_(f,k,Math.max));else{k='"'+k.string+'"';g=!0;f&&(d.push(sre.AuditoryDescription.sexpPause_(f)),f=null);var l=sre.AuditoryDescription.sexpProsody_(e);
d.push(l?"(text ("+l+") "+k+")":k)}return"(exp "+d.join(b)+")"};sre.AuditoryDescription.mergePause_=function(a,b,c){return a?{pause:(c||function(a,b){return a+b}).call(null,a.pause,b.pause)}:b};sre.AuditoryDescription.mergeMarkup_=function(a,b){delete a.open;b.close.forEach(function(b){delete a[b]});b.open.forEach(function(c){a[c]=b[c]});var c=Object.keys(a);a.open=c};
sre.AuditoryDescription.sexpProsody_=function(a){for(var b=a.open,c=[],d=0,e;e=b[d];d++)c.push(sre.AuditoryDescription.sexpProsodyElement_(e,a[e]));return c.join(" ")};
sre.AuditoryDescription.sexpProsodyElement_=function(a,b){b=sre.AuditoryDescription.applyScaleFunction(b);switch(a){case sre.Engine.personalityProps.RATE:return"(richness . "+b+")";case sre.Engine.personalityProps.PITCH:return"(average-pitch . "+b+")";case sre.Engine.personalityProps.VOLUME:return"(stress . "+b+")"}return"(value . "+b+")"};sre.AuditoryDescription.sexpPause_=function(a){return"(pause . "+a[sre.Engine.personalityProps.PAUSE]+")"};
sre.AuditoryDescription.toMarkupString_=function(a,b){sre.AuditoryDescription.setScaleFunction(-2,2,-100,100,2);for(var c=sre.Engine.getInstance().markup===sre.Engine.Markup.SABLE,d=c?sre.AuditoryDescription.translateSableTags:sre.AuditoryDescription.translateSsmlTags,e=sre.AuditoryDescription.personalityMarkup_(a),f=[],g=[],h=0,k;k=e[h];h++)if(k.string)f.push(k.string);else if(sre.AuditoryDescription.isPauseElement_(k))f.push("<BREAK "+(c?'MSEC="'+k[sre.Engine.personalityProps.PAUSE]+'"/>':'TIME="'+
k[sre.Engine.personalityProps.PAUSE]+'ms"/>'));else{if(k.close.length)for(var l=0;l<k.close.length;l++){var m=g.pop();if(-1===k.close.indexOf(m))throw Error("Unknown closing markup element: "+m);f.push("</"+(c?m.toUpperCase():"PROSODY")+">")}k.open.length&&sre.AuditoryDescription.sortClose(k.open.slice(),e.slice(h+1)).forEach(function(a){f.push(d(a,k[a]));g.push(a)})}return f.join(b)};
sre.AuditoryDescription.sortClose=function(a,b){if(1>=a.length)return a;for(var c=[],d=0,e;e=b[d],a.length;d++)e.close&&e.close.length&&e.close.forEach(function(b){var d=a.indexOf(b);-1!==d&&(c.unshift(b),a.splice(d,1))});return c};
sre.AuditoryDescription.translateSableTags=function(a,b){b=sre.AuditoryDescription.applyScaleFunction(b);switch(a){case sre.Engine.personalityProps.PITCH:return'<PITCH BASE="'+b+'%">';case sre.Engine.personalityProps.RATE:return'<RATE SPEED="'+b+'%">';case sre.Engine.personalityProps.VOLUME:return'<VOLUME LEVEL="'+b+'%">';default:return"<"+a.toUpperCase()+' VALUE="'+b+'">'}};
sre.AuditoryDescription.translateSsmlTags=function(a,b){b=sre.AuditoryDescription.applyScaleFunction(b);var c=0>b?b.toString():"+"+b;return"<PROSODY "+a.toUpperCase()+'="'+c+(a===sre.Engine.personalityProps.VOLUME?">":'%">')};sre.AuditoryDescription.setScaleFunction=function(a,b,c,d,e){var f=e||0;sre.AuditoryDescription.SCALE=function(e){e=(e-a)/(b-a);return+(Math.round(c*(1-e)+d*e+"e+"+f)+"e-"+f)}};
sre.AuditoryDescription.applyScaleFunction=function(a){return sre.AuditoryDescription.SCALE?sre.AuditoryDescription.SCALE(a):a};sre.AuditoryDescription.PersonalityRanges_={};sre.AuditoryDescription.LastOpen_=[];
sre.AuditoryDescription.personalityMarkup_=function(a){sre.AuditoryDescription.PersonalityRanges_={};sre.AuditoryDescription.LastOpen_=[];for(var b=[],c={},d=0,e;e=a[d];d++){var f=null,g=e.descriptionString();e=e.personality;void 0!==e[sre.Engine.personalityProps.PAUSE]&&(f={},f[sre.Engine.personalityProps.PAUSE]=e[sre.Engine.personalityProps.PAUSE],delete e[sre.Engine.personalityProps.PAUSE]);e=sre.AuditoryDescription.personalityDiff_(e,c);sre.AuditoryDescription.appendMarkup_(b,g,e,f,!0)}return b};
sre.AuditoryDescription.isMarkupElement_=function(a){return"object"===typeof a&&a.open};sre.AuditoryDescription.isPauseElement_=function(a){return"object"===typeof a&&1===Object.keys(a).length&&Object.keys(a)[0]===sre.Engine.personalityProps.PAUSE};sre.AuditoryDescription.isStringElement_=function(a){return"object"===typeof a&&1===Object.keys(a).length&&"string"===Object.keys(a)[0]};
sre.AuditoryDescription.appendMarkup_=function(a,b,c,d,e){if(e){if((e=a[a.length-1])&&!b&&d&&sre.AuditoryDescription.isPauseElement_(e)){var f=sre.Engine.personalityProps.PAUSE;e[f]+=d[f];d=null}e&&b&&0===Object.keys(c).length&&sre.AuditoryDescription.isStringElement_(e)&&(e.string+=" "+b,b="")}0!==Object.keys(c).length&&a.push(c);b&&a.push({string:b});d&&a.push(d)};
sre.AuditoryDescription.personalityDiff_=function(a,b){if(!b)return a;var c={},d;for(d in sre.Engine.personalityProps){var e=sre.Engine.personalityProps[d],f=a[e],g=b[e];if(!(!f&&!g||f&&g&&f===g)){var h=f||0;sre.AuditoryDescription.isMarkupElement_(c)||(c.open=[],c.close=[]);f||c.close.push(e);g||c.open.push(e);g&&f&&(c.close.push(e),c.open.push(e));b[e]=h;c[e]=h;sre.AuditoryDescription.PersonalityRanges_[e]?sre.AuditoryDescription.PersonalityRanges_[e].push(h):sre.AuditoryDescription.PersonalityRanges_[e]=
[h]}}if(sre.AuditoryDescription.isMarkupElement_(c)){for(d=c.close.slice();0<d.length;)if(e=sre.AuditoryDescription.LastOpen_.pop(),f=sre.BaseUtil.setdifference(e,d),d=sre.BaseUtil.setdifference(d,e),e=f,0===d.length)0!==e.length&&sre.AuditoryDescription.LastOpen_.push(e);else if(0!==e.length)for(c.close=c.close.concat(e),c.open=c.open.concat(e),f=0;g=e[f];f++)c[g]=b[g];sre.AuditoryDescription.LastOpen_.push(c.open)}return c};
sre.AuditoryDescription.mergeStrings=function(a){switch(sre.Engine.getInstance().markup){case sre.Engine.Markup.ACSS:return"(exp "+a.map(function(a){return a.replace(/^\(exp /,"").replace(/\)$/,"")}).join(" ")+")";default:return a.join(" ")}};sre.AuditoryDescription.error=function(a){switch(sre.Engine.getInstance().markup){case sre.Engine.Markup.ACSS:return'(error "'+a+'")';default:return null}};sre.Debugger=function(){this.isActive_=!1;this.outputFunction_=console.log;this.stream_=null};goog.addSingletonGetter(sre.Debugger);sre.Debugger.prototype.init=function(a){a&&this.startDebugFile_(a);this.isActive_=!0};
...
sre.SemanticMathml.prototype.number_=function(a,b){var c=this.leaf_(a);sre.SemanticProcessor.number(c);return c};sre.SemanticMathml.prototype.operator_=function(a,b){var c=this.leaf_(a);c.type===sre.SemanticAttr.Type.UNKNOWN&&(c.type=sre.SemanticAttr.Type.OPERATOR);return c};
...
sre.Grammar.parseInput=function(a){var b={};a=a.split(":");for(var c=0,d=a.length;c<d;c++){var e=a[c].split("="),f=e[0].trim();e[1]?b[f]=e[1].trim():f.match(/^!/)?b[f.slice(1)]=!1:b[f]=!0}return b};sre.Grammar.correctFont_=function(a,b){if(!b||!a)return a;var c=b.split(/ |-/),c=new RegExp("^"+c.join("( |-)")+"( |-)");return a.replace(c,"")};sre.Grammar.addAnnotation_=function(a,b){return a+":"+b};sre.Grammar.getInstance().setCorrection("ignoreFont",sre.Grammar.correctFont_);
...
sre.Trie.prototype.lookupRules=function(a,b){for(var c=[this.root],d=[],e=this.dynamicCstrSets_(b);e.length;){for(var f=e.shift(),g=[];c.length;){var h=c.shift(),h=h.getChildren();h.forEach(function(a){a.getKind()===sre.TrieNode.Kind.DYNAMIC&&-1===f.indexOf(a.getConstraint())||g.push(a)})}c=g.slice()}for(;c.length;)h=c.shift(),h.getRule&&(e=h.getRule())&&d.push(e),h=h.findChildren(a),c=c.concat(h);return d};
...
sre.BaseRuleStore.prototype.lookupRule=function(a,b){if(!a||a.nodeType!=sre.DomUtil.NodeType.ELEMENT_NODE&&a.nodeType!=sre.DomUtil.NodeType.TEXT_NODE)return null;var c=this.trie.lookupRules(a,b);return 0<c.length?this.pickMostConstraint_(b,c):null};
...
'[t] "collapsed power"',"self::superscript","@alternative","self::*","self::*","self::*");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-superscript","mathspeak.default","mathspeak.brief");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-superscript","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-subscript","mathspeak.default",'[t] "collapsed subscript"',"self::subscript","@alternative","self::*","self::*","self::*");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-subscript",
...
return sre.AuditoryDescription.mergeStrings(d)};sre.AbstractWalker.prototype.levelAnnouncement_=function(a){var b=this.focus_.getDomPrimary(),b=this.expandable(b)&&"expandable"||this.collapsible(b)&&"collapsible"||"",c=[sre.AuditoryDescription.speechString([new sre.AuditoryDescription({text:"Level "+this.getDepth(),personality:{}})])];a&&c.push(a);b&&c.push(b);return sre.AuditoryDescription.mergeStrings(c)};
